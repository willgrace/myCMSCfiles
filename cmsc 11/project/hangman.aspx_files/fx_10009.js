...
{this.options={delay:0,from:0,to:1.0,fps:60,duration:2000,transition:$iTXT.fx.Transition.Linear,start:false,targetChildren:false};$iTXT.core.Util.extend(this.options,_options);if(this.options.target)
...
{setTimeout($iTXT.core.Event.bind(this,this._start),this.options.delay);},setup:function()
...
o=1-o;if(this.options.targetChildren)
{for(var i=0;i<this.target.childNodes.length;i++)
{$iTXT.core.$(this.target.childNodes[i].firstChild).ixtOpacity(o);}}
else
{this.target.ixtOpacity(o);}}});}

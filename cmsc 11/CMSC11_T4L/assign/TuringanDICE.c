/* Jennifer H. Turingan CMSC 11 F-2L "Special Exercise-Assignment"

>>>>>>>>>THE DICE COMBOS<<<<<<<<<< 

	SPECIAL COMBINATIONS with their respective credits/consequences:
		n-n-n = 3x
		1-2-3 = -x2
		456 = x2
		 where 
	Note: Every TURN counts. "No Combo = Lose Turn".
	
	CHALLENGING PART; "The Dice Battle"
		In this round, 
